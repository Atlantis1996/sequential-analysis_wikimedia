...
q10() {
  ...
  echo "The EC2 or any machine that this program runs on might not have enough memory and computational capabilities, without using parallelism."
}
